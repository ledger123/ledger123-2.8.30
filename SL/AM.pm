...
# bp 2014/10 $folders variable is empty, @accessfolders in sql-ledger.conf is an directory array
#            templates directory hardcoded to: templates/dbname/lang/file
...
sub load_template {
  my ($self, $form) = @_;
# bp 2014/10 function parameters inconsistent with function call in am.pl
...
sub save_defaults {
  ...
  for (qw(glnumber sinumber vinumber batchnumber vouchernumber sonumber ponumber sqnumber rfqnumber partnumber employeenumber customernumber vendornumber projectnumber precision maxpricedecimals)) {
